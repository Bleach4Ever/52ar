...
import com.ysx.w2ar.base.dao.tables.YsxMoocClassMemberDao;
 ...
 */
@Service
public class YsxMoocClassMemberManager implements IYsxMoocClassMemberManager {

    private final Logger LOG = Logger.getLogger(getClass());

    @Autowired
    private YsxMoocClassMemberDao ysxMoocClassMemberDao;
    ...
    public void getInsert(YsxMoocClassMemberBean ysxMoocClassMember) throws Exception
    {
        ...
        // 非空判断
        if( null != ysxMoocClassMember )
        {
            // 执行新增一条数据
            ysxMoocClassMemberDao.getInsert(ysxMoocClassMember);
        }
    }
    ...
    public int getDelete(long moocClassMemberId) throws Exception
    {
        ...
        // 非空判断
        if( moocClassMemberId > -1 )
        {
            // 执行删除一条数据
            return ysxMoocClassMemberDao.getDelete(moocClassMemberId);
        }
        return 0;
    }
    ...
    public int getUpdate(YsxMoocClassMemberBean ysxMoocClassMember) throws Exception
    {
        ...
        {
            // 执行变更一条数据
            return ysxMoocClassMemberDao.getUpdate(ysxMoocClassMember);
        }
        return 0;
    }
    ...
    public YsxMoocClassMemberBean getBean(long moocClassMemberId) throws Exception
    {
        ...
        {
            // 执行获取一个Bean实体
            return ysxMoocClassMemberDao.getBean(moocClassMemberId);
        }
        return null;
    }
    ...
    public List<YsxMoocClassMemberBean> getList(YsxMoocClassMemberBean ysxMoocClassMember) throws Exception
    {
        ...
        {
            // 执行条件查询
            return ysxMoocClassMemberDao.getList(ysxMoocClassMember);
        }
        return null;
    }
    ...
    public int getDeleteBean(YsxMoocClassMemberBean ysxMoocClassMember) throws Exception
    {
        ...
        {
            // 执行删除一条数据
            return ysxMoocClassMemberDao.getDeleteBean(ysxMoocClassMember);
        }
        return 0;
    }
    ...
    public int getDeleteIn(long[] IDs) throws Exception
    {
        ...
        {
            // 执行删除多条数据
            return ysxMoocClassMemberDao.getDeleteIn(IDs);
        }
        return 0;
    }
    ...
    public int getDeleteBy(YsxMoocClassMemberBean ysxMoocClassMember) throws Exception
    {
        ...
        {
            // 执行删除批量数据
            return ysxMoocClassMemberDao.getDeleteBy(ysxMoocClassMember);
        }
        return 0;
    }
    ...
    public int getUpdateBy(YsxMoocClassMemberBean ysxMoocClassMember) throws Exception
    {
        ...
        {
            // 执行变更批量数据
            return ysxMoocClassMemberDao.getUpdateBy(ysxMoocClassMember);
        }
        return 0;
    }
    ...
    public int getCheck(long moocClassMemberId) throws Exception
    {
        ...
        {
            // 执行验证一条数据是否存在
            return ysxMoocClassMemberDao.getCheck(moocClassMemberId);
        }
        return 0;
    }
    ...
    public int getCheckBy(YsxMoocClassMemberBean ysxMoocClassMember) throws Exception
    {
        ...
        {
            // 执行验证多条件数据是否存在
            return ysxMoocClassMemberDao.getCheckBy(ysxMoocClassMember);
        }
        return 0;
    }
    ...
    public void getInsertBatch(List<YsxMoocClassMemberBean> list) throws Exception
    {
        ...
        {
            // 执行Batch - 批量新增数据
            ysxMoocClassMemberDao.getInsertBatch(list);
        }
    }
