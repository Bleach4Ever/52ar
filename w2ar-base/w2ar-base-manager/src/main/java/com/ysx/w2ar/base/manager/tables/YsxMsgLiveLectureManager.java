...
import com.ysx.w2ar.base.dao.tables.YsxMsgLiveLectureDao;
 ...
 */
@Service
public class YsxMsgLiveLectureManager implements IYsxMsgLiveLectureManager {

    private final Logger LOG = Logger.getLogger(getClass());

    @Autowired
    private YsxMsgLiveLectureDao ysxMsgLiveLectureDao;
    ...
    public void getInsert(YsxMsgLiveLectureBean ysxMsgLiveLecture) throws Exception
    {
        ...
        // 非空判断
        if( null != ysxMsgLiveLecture )
        {
            // 执行新增一条数据
            ysxMsgLiveLectureDao.getInsert(ysxMsgLiveLecture);
        }
    }
    ...
    public int getDelete(long msgId) throws Exception
    {
        ...
        {
            // 执行删除一条数据
            return ysxMsgLiveLectureDao.getDelete(msgId);
        }
        return 0;
    }
    ...
    public int getUpdate(YsxMsgLiveLectureBean ysxMsgLiveLecture) throws Exception
    {
        ...
        {
            // 执行变更一条数据
            return ysxMsgLiveLectureDao.getUpdate(ysxMsgLiveLecture);
        }
        return 0;
    }
    ...
    public YsxMsgLiveLectureBean getBean(long msgId) throws Exception
    {
        ...
        {
            // 执行获取一个Bean实体
            return ysxMsgLiveLectureDao.getBean(msgId);
        }
        return null;
    }
    ...
    public List<YsxMsgLiveLectureBean> getList(YsxMsgLiveLectureBean ysxMsgLiveLecture) throws Exception
    {
        ...
        {
            // 执行条件查询
            return ysxMsgLiveLectureDao.getList(ysxMsgLiveLecture);
        }
        return null;
    }
    ...
    public int getDeleteBean(YsxMsgLiveLectureBean ysxMsgLiveLecture) throws Exception
    {
        ...
        {
            // 执行删除一条数据
            return ysxMsgLiveLectureDao.getDeleteBean(ysxMsgLiveLecture);
        }
        return 0;
    }
    ...
    public int getDeleteIn(long[] IDs) throws Exception
    {
        ...
        {
            // 执行删除多条数据
            return ysxMsgLiveLectureDao.getDeleteIn(IDs);
        }
        return 0;
    }
    ...
    public int getDeleteBy(YsxMsgLiveLectureBean ysxMsgLiveLecture) throws Exception
    {
        ...
        {
            // 执行删除批量数据
            return ysxMsgLiveLectureDao.getDeleteBy(ysxMsgLiveLecture);
        }
        return 0;
    }
    ...
    public int getUpdateBy(YsxMsgLiveLectureBean ysxMsgLiveLecture) throws Exception
    {
        ...
        {
            // 执行变更批量数据
            return ysxMsgLiveLectureDao.getUpdateBy(ysxMsgLiveLecture);
        }
        return 0;
    }
    ...
    public int getCheck(long msgId) throws Exception
    {
        ...
        {
            // 执行验证一条数据是否存在
            return ysxMsgLiveLectureDao.getCheck(msgId);
        }
        return 0;
    }
    ...
    public int getCheckBy(YsxMsgLiveLectureBean ysxMsgLiveLecture) throws Exception
    {
        ...
        {
            // 执行验证多条件数据是否存在
            return ysxMsgLiveLectureDao.getCheckBy(ysxMsgLiveLecture);
        }
        return 0;
    }
    ...
    public void getInsertBatch(List<YsxMsgLiveLectureBean> list) throws Exception
    {
        ...
        {
            // 执行Batch - 批量新增数据
            ysxMsgLiveLectureDao.getInsertBatch(list);
        }
    }
