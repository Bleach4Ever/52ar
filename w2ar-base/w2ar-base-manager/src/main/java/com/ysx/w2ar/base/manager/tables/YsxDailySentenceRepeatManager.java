...
import com.ysx.w2ar.base.dao.tables.YsxDailySentenceRepeatDao;
 ...
 */
@Service
public class YsxDailySentenceRepeatManager implements IYsxDailySentenceRepeatManager {

    private final Logger LOG = Logger.getLogger(getClass());

    @Autowired
    private YsxDailySentenceRepeatDao ysxDailySentenceRepeatDao;
    ...
    public void getInsert(YsxDailySentenceRepeatBean ysxDailySentenceRepeat) throws Exception
    {
        ...
        // 非空判断
        if( null != ysxDailySentenceRepeat )
        {
            // 执行新增一条数据
            ysxDailySentenceRepeatDao.getInsert(ysxDailySentenceRepeat);
        }
    }
    ...
    public int getDelete(long dailySentenceRepeatId) throws Exception
    {
        ...
        // 非空判断
        if( dailySentenceRepeatId > -1 )
        {
            // 执行删除一条数据
            return ysxDailySentenceRepeatDao.getDelete(dailySentenceRepeatId);
        }
        return 0;
    }
    ...
    public int getUpdate(YsxDailySentenceRepeatBean ysxDailySentenceRepeat) throws Exception
    {
        ...
        {
            // 执行变更一条数据
            return ysxDailySentenceRepeatDao.getUpdate(ysxDailySentenceRepeat);
        }
        return 0;
    }
    ...
    public YsxDailySentenceRepeatBean getBean(long dailySentenceRepeatId) throws Exception
    {
        ...
        {
            // 执行获取一个Bean实体
            return ysxDailySentenceRepeatDao.getBean(dailySentenceRepeatId);
        }
        return null;
    }
    ...
    public List<YsxDailySentenceRepeatBean> getList(YsxDailySentenceRepeatBean ysxDailySentenceRepeat) throws Exception
    {
        ...
        {
            // 执行条件查询
            return ysxDailySentenceRepeatDao.getList(ysxDailySentenceRepeat);
        }
        return null;
    }
    ...
    public int getDeleteBean(YsxDailySentenceRepeatBean ysxDailySentenceRepeat) throws Exception
    {
        ...
        {
            // 执行删除一条数据
            return ysxDailySentenceRepeatDao.getDeleteBean(ysxDailySentenceRepeat);
        }
        return 0;
    }
    ...
    public int getDeleteIn(long[] IDs) throws Exception
    {
        ...
        {
            // 执行删除多条数据
            return ysxDailySentenceRepeatDao.getDeleteIn(IDs);
        }
        return 0;
    }
    ...
    public int getDeleteBy(YsxDailySentenceRepeatBean ysxDailySentenceRepeat) throws Exception
    {
        ...
        {
            // 执行删除批量数据
            return ysxDailySentenceRepeatDao.getDeleteBy(ysxDailySentenceRepeat);
        }
        return 0;
    }
    ...
    public int getUpdateBy(YsxDailySentenceRepeatBean ysxDailySentenceRepeat) throws Exception
    {
        ...
        {
            // 执行变更批量数据
            return ysxDailySentenceRepeatDao.getUpdateBy(ysxDailySentenceRepeat);
        }
        return 0;
    }
    ...
    public int getCheck(long dailySentenceRepeatId) throws Exception
    {
        ...
        {
            // 执行验证一条数据是否存在
            return ysxDailySentenceRepeatDao.getCheck(dailySentenceRepeatId);
        }
        return 0;
    }
    ...
    public int getCheckBy(YsxDailySentenceRepeatBean ysxDailySentenceRepeat) throws Exception
    {
        ...
        {
            // 执行验证多条件数据是否存在
            return ysxDailySentenceRepeatDao.getCheckBy(ysxDailySentenceRepeat);
        }
        return 0;
    }
    ...
    public void getInsertBatch(List<YsxDailySentenceRepeatBean> list) throws Exception
    {
        ...
        {
            // 执行Batch - 批量新增数据
            ysxDailySentenceRepeatDao.getInsertBatch(list);
        }
    }
