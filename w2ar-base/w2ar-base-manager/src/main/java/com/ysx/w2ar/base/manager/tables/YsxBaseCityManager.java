...
import com.ysx.w2ar.base.dao.tables.YsxBaseCityDao;
 ...
 */
@Service
public class YsxBaseCityManager implements IYsxBaseCityManager {

    private final Logger LOG = Logger.getLogger(getClass());

    @Autowired
    private YsxBaseCityDao ysxBaseCityDao;
    ...
    public void getInsert(YsxBaseCityBean ysxBaseCity) throws Exception
    {
        ...
        {
            // 执行新增一条数据
            ysxBaseCityDao.getInsert(ysxBaseCity);
        }
    }
    ...
    public int getDelete(long cityId) throws Exception
    {
        ...
        {
            // 执行删除一条数据
            return ysxBaseCityDao.getDelete(cityId);
        }
        return 0;
    }
    ...
    public int getUpdate(YsxBaseCityBean ysxBaseCity) throws Exception
    {
        ...
        {
            // 执行变更一条数据
            return ysxBaseCityDao.getUpdate(ysxBaseCity);
        }
        return 0;
    }
    ...
    public YsxBaseCityBean getBean(long cityId) throws Exception
    {
        ...
        {
            // 执行获取一个Bean实体
            return ysxBaseCityDao.getBean(cityId);
        }
        return null;
    }
    ...
    public List<YsxBaseCityBean> getList(YsxBaseCityBean ysxBaseCity) throws Exception
    {
        ...
        {
            // 执行条件查询
            return ysxBaseCityDao.getList(ysxBaseCity);
        }
        return null;
    }
    ...
    public int getDeleteBean(YsxBaseCityBean ysxBaseCity) throws Exception
    {
        ...
        {
            // 执行删除一条数据
            return ysxBaseCityDao.getDeleteBean(ysxBaseCity);
        }
        return 0;
    }
    ...
    public int getDeleteIn(long[] IDs) throws Exception
    {
        ...
        {
            // 执行删除多条数据
            return ysxBaseCityDao.getDeleteIn(IDs);
        }
        return 0;
    }
    ...
    public int getDeleteBy(YsxBaseCityBean ysxBaseCity) throws Exception
    {
        ...
        {
            // 执行删除批量数据
            return ysxBaseCityDao.getDeleteBy(ysxBaseCity);
        }
        return 0;
    }
    ...
    public int getUpdateBy(YsxBaseCityBean ysxBaseCity) throws Exception
    {
        ...
        {
            // 执行变更批量数据
            return ysxBaseCityDao.getUpdateBy(ysxBaseCity);
        }
        return 0;
    }
    ...
    public int getCheck(long cityId) throws Exception
    {
        ...
        {
            // 执行验证一条数据是否存在
            return ysxBaseCityDao.getCheck(cityId);
        }
        return 0;
    }
    ...
    public int getCheckBy(YsxBaseCityBean ysxBaseCity) throws Exception
    {
        ...
        {
            // 执行验证多条件数据是否存在
            return ysxBaseCityDao.getCheckBy(ysxBaseCity);
        }
        return 0;
    }
    ...
    public void getInsertBatch(List<YsxBaseCityBean> list) throws Exception
    {
        ...
        {
            // 执行Batch - 批量新增数据
            ysxBaseCityDao.getInsertBatch(list);
        }
    }
