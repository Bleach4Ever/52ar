...
import com.ysx.w2ar.base.dao.tables.YsxVoteOptionDao;
 ...
 */
@Service
public class YsxVoteOptionManager implements IYsxVoteOptionManager {

    private final Logger LOG = Logger.getLogger(getClass());

    @Autowired
    private YsxVoteOptionDao ysxVoteOptionDao;
    ...
    public void getInsert(YsxVoteOptionBean ysxVoteOption) throws Exception
    {
        ...
        // 非空判断
        if( null != ysxVoteOption )
        {
            // 执行新增一条数据
            ysxVoteOptionDao.getInsert(ysxVoteOption);
        }
    }
    ...
    public int getDelete(long voteOptionId) throws Exception
    {
        ...
        {
            // 执行删除一条数据
            return ysxVoteOptionDao.getDelete(voteOptionId);
        }
        return 0;
    }
    ...
    public int getUpdate(YsxVoteOptionBean ysxVoteOption) throws Exception
    {
        ...
        {
            // 执行变更一条数据
            return ysxVoteOptionDao.getUpdate(ysxVoteOption);
        }
        return 0;
    }
    ...
    public YsxVoteOptionBean getBean(long voteOptionId) throws Exception
    {
        ...
        {
            // 执行获取一个Bean实体
            return ysxVoteOptionDao.getBean(voteOptionId);
        }
        return null;
    }
    ...
    public List<YsxVoteOptionBean> getList(YsxVoteOptionBean ysxVoteOption) throws Exception
    {
        ...
        {
            // 执行条件查询
            return ysxVoteOptionDao.getList(ysxVoteOption);
        }
        return null;
    }
    ...
    public int getDeleteBean(YsxVoteOptionBean ysxVoteOption) throws Exception
    {
        ...
        {
            // 执行删除一条数据
            return ysxVoteOptionDao.getDeleteBean(ysxVoteOption);
        }
        return 0;
    }
    ...
    public int getDeleteIn(long[] IDs) throws Exception
    {
        ...
        {
            // 执行删除多条数据
            return ysxVoteOptionDao.getDeleteIn(IDs);
        }
        return 0;
    }
    ...
    public int getDeleteBy(YsxVoteOptionBean ysxVoteOption) throws Exception
    {
        ...
        {
            // 执行删除批量数据
            return ysxVoteOptionDao.getDeleteBy(ysxVoteOption);
        }
        return 0;
    }
    ...
    public int getUpdateBy(YsxVoteOptionBean ysxVoteOption) throws Exception
    {
        ...
        {
            // 执行变更批量数据
            return ysxVoteOptionDao.getUpdateBy(ysxVoteOption);
        }
        return 0;
    }
    ...
    public int getCheck(long voteOptionId) throws Exception
    {
        ...
        {
            // 执行验证一条数据是否存在
            return ysxVoteOptionDao.getCheck(voteOptionId);
        }
        return 0;
    }
    ...
    public int getCheckBy(YsxVoteOptionBean ysxVoteOption) throws Exception
    {
        ...
        {
            // 执行验证多条件数据是否存在
            return ysxVoteOptionDao.getCheckBy(ysxVoteOption);
        }
        return 0;
    }
    ...
    public void getInsertBatch(List<YsxVoteOptionBean> list) throws Exception
    {
        ...
        {
            // 执行Batch - 批量新增数据
            ysxVoteOptionDao.getInsertBatch(list);
        }
    }
