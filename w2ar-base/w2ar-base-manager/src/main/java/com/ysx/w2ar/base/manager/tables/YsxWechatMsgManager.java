...
import com.ysx.w2ar.base.dao.tables.YsxWechatMsgDao;
 ...
 */
@Service
public class YsxWechatMsgManager implements IYsxWechatMsgManager {

    private final Logger LOG = Logger.getLogger(getClass());

    @Autowired
    private YsxWechatMsgDao ysxWechatMsgDao;
    ...
    public void getInsert(YsxWechatMsgBean ysxWechatMsg) throws Exception
    {
        ...
        // 非空判断
        if( null != ysxWechatMsg )
        {
            // 执行新增一条数据
            ysxWechatMsgDao.getInsert(ysxWechatMsg);
        }
    }
    ...
    public int getDelete(long msgId) throws Exception
    {
        ...
        {
            // 执行删除一条数据
            return ysxWechatMsgDao.getDelete(msgId);
        }
        return 0;
    }
    ...
    public int getUpdate(YsxWechatMsgBean ysxWechatMsg) throws Exception
    {
        ...
        {
            // 执行变更一条数据
            return ysxWechatMsgDao.getUpdate(ysxWechatMsg);
        }
        return 0;
    }
    ...
    public YsxWechatMsgBean getBean(long msgId) throws Exception
    {
        ...
        {
            // 执行获取一个Bean实体
            return ysxWechatMsgDao.getBean(msgId);
        }
        return null;
    }
    ...
    public List<YsxWechatMsgBean> getList(YsxWechatMsgBean ysxWechatMsg) throws Exception
    {
        ...
        {
            // 执行条件查询
            return ysxWechatMsgDao.getList(ysxWechatMsg);
        }
        return null;
    }
    ...
    public int getDeleteBean(YsxWechatMsgBean ysxWechatMsg) throws Exception
    {
        ...
        {
            // 执行删除一条数据
            return ysxWechatMsgDao.getDeleteBean(ysxWechatMsg);
        }
        return 0;
    }
    ...
    public int getDeleteIn(long[] IDs) throws Exception
    {
        ...
        {
            // 执行删除多条数据
            return ysxWechatMsgDao.getDeleteIn(IDs);
        }
        return 0;
    }
    ...
    public int getDeleteBy(YsxWechatMsgBean ysxWechatMsg) throws Exception
    {
        ...
        {
            // 执行删除批量数据
            return ysxWechatMsgDao.getDeleteBy(ysxWechatMsg);
        }
        return 0;
    }
    ...
    public int getUpdateBy(YsxWechatMsgBean ysxWechatMsg) throws Exception
    {
        ...
        {
            // 执行变更批量数据
            return ysxWechatMsgDao.getUpdateBy(ysxWechatMsg);
        }
        return 0;
    }
    ...
    public int getCheck(long msgId) throws Exception
    {
        ...
        {
            // 执行验证一条数据是否存在
            return ysxWechatMsgDao.getCheck(msgId);
        }
        return 0;
    }
    ...
    public int getCheckBy(YsxWechatMsgBean ysxWechatMsg) throws Exception
    {
        ...
        {
            // 执行验证多条件数据是否存在
            return ysxWechatMsgDao.getCheckBy(ysxWechatMsg);
        }
        return 0;
    }
    ...
    public void getInsertBatch(List<YsxWechatMsgBean> list) throws Exception
    {
        ...
        {
            // 执行Batch - 批量新增数据
            ysxWechatMsgDao.getInsertBatch(list);
        }
    }
