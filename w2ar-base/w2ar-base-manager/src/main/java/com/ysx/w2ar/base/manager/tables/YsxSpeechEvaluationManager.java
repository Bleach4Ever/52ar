...
import com.ysx.w2ar.base.dao.tables.YsxSpeechEvaluationDao;
 ...
 */
@Service
public class YsxSpeechEvaluationManager implements IYsxSpeechEvaluationManager {

    private final Logger LOG = Logger.getLogger(getClass());

    @Autowired
    private YsxSpeechEvaluationDao ysxSpeechEvaluationDao;
    ...
    public void getInsert(YsxSpeechEvaluationBean ysxSpeechEvaluation) throws Exception
    {
        ...
        // 非空判断
        if( null != ysxSpeechEvaluation )
        {
            // 执行新增一条数据
            ysxSpeechEvaluationDao.getInsert(ysxSpeechEvaluation);
        }
    }
    ...
    public int getDelete(long speechEvaluationId) throws Exception
    {
        ...
        // 非空判断
        if( speechEvaluationId > -1 )
        {
            // 执行删除一条数据
            return ysxSpeechEvaluationDao.getDelete(speechEvaluationId);
        }
        return 0;
    }
    ...
    public int getUpdate(YsxSpeechEvaluationBean ysxSpeechEvaluation) throws Exception
    {
        ...
        {
            // 执行变更一条数据
            return ysxSpeechEvaluationDao.getUpdate(ysxSpeechEvaluation);
        }
        return 0;
    }
    ...
    public YsxSpeechEvaluationBean getBean(long speechEvaluationId) throws Exception
    {
        ...
        {
            // 执行获取一个Bean实体
            return ysxSpeechEvaluationDao.getBean(speechEvaluationId);
        }
        return null;
    }
    ...
    public List<YsxSpeechEvaluationBean> getList(YsxSpeechEvaluationBean ysxSpeechEvaluation) throws Exception
    {
        ...
        {
            // 执行条件查询
            return ysxSpeechEvaluationDao.getList(ysxSpeechEvaluation);
        }
        return null;
    }
    ...
    public int getDeleteBean(YsxSpeechEvaluationBean ysxSpeechEvaluation) throws Exception
    {
        ...
        {
            // 执行删除一条数据
            return ysxSpeechEvaluationDao.getDeleteBean(ysxSpeechEvaluation);
        }
        return 0;
    }
    ...
    public int getDeleteIn(long[] IDs) throws Exception
    {
        ...
        {
            // 执行删除多条数据
            return ysxSpeechEvaluationDao.getDeleteIn(IDs);
        }
        return 0;
    }
    ...
    public int getDeleteBy(YsxSpeechEvaluationBean ysxSpeechEvaluation) throws Exception
    {
        ...
        {
            // 执行删除批量数据
            return ysxSpeechEvaluationDao.getDeleteBy(ysxSpeechEvaluation);
        }
        return 0;
    }
    ...
    public int getUpdateBy(YsxSpeechEvaluationBean ysxSpeechEvaluation) throws Exception
    {
        ...
        {
            // 执行变更批量数据
            return ysxSpeechEvaluationDao.getUpdateBy(ysxSpeechEvaluation);
        }
        return 0;
    }
    ...
    public int getCheck(long speechEvaluationId) throws Exception
    {
        ...
        {
            // 执行验证一条数据是否存在
            return ysxSpeechEvaluationDao.getCheck(speechEvaluationId);
        }
        return 0;
    }
    ...
    public int getCheckBy(YsxSpeechEvaluationBean ysxSpeechEvaluation) throws Exception
    {
        ...
        {
            // 执行验证多条件数据是否存在
            return ysxSpeechEvaluationDao.getCheckBy(ysxSpeechEvaluation);
        }
        return 0;
    }
    ...
    public void getInsertBatch(List<YsxSpeechEvaluationBean> list) throws Exception
    {
        ...
        {
            // 执行Batch - 批量新增数据
            ysxSpeechEvaluationDao.getInsertBatch(list);
        }
    }
