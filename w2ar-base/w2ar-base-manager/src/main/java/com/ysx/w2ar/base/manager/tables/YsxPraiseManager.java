...
import com.ysx.w2ar.base.dao.tables.YsxPraiseDao;
 ...
 */
@Service
public class YsxPraiseManager implements IYsxPraiseManager {

    private final Logger LOG = Logger.getLogger(getClass());

    @Autowired
    private YsxPraiseDao ysxPraiseDao;
    ...
    public void getInsert(YsxPraiseBean ysxPraise) throws Exception
    {
        ...
        {
            // 执行新增一条数据
            ysxPraiseDao.getInsert(ysxPraise);
        }
    }
    ...
    public int getDelete(long praiseId) throws Exception
    {
        ...
        {
            // 执行删除一条数据
            return ysxPraiseDao.getDelete(praiseId);
        }
        return 0;
    }
    ...
    public int getUpdate(YsxPraiseBean ysxPraise) throws Exception
    {
        ...
        {
            // 执行变更一条数据
            return ysxPraiseDao.getUpdate(ysxPraise);
        }
        return 0;
    }
    ...
    public YsxPraiseBean getBean(long praiseId) throws Exception
    {
        ...
        {
            // 执行获取一个Bean实体
            return ysxPraiseDao.getBean(praiseId);
        }
        return null;
    }
    ...
    public List<YsxPraiseBean> getList(YsxPraiseBean ysxPraise) throws Exception
    {
        ...
        {
            // 执行条件查询
            return ysxPraiseDao.getList(ysxPraise);
        }
        return null;
    }
    ...
    public int getDeleteBean(YsxPraiseBean ysxPraise) throws Exception
    {
        ...
        {
            // 执行删除一条数据
            return ysxPraiseDao.getDeleteBean(ysxPraise);
        }
        return 0;
    }
    ...
    public int getDeleteIn(long[] IDs) throws Exception
    {
        ...
        {
            // 执行删除多条数据
            return ysxPraiseDao.getDeleteIn(IDs);
        }
        return 0;
    }
    ...
    public int getDeleteBy(YsxPraiseBean ysxPraise) throws Exception
    {
        ...
        {
            // 执行删除批量数据
            return ysxPraiseDao.getDeleteBy(ysxPraise);
        }
        return 0;
    }
    ...
    public int getUpdateBy(YsxPraiseBean ysxPraise) throws Exception
    {
        ...
        {
            // 执行变更批量数据
            return ysxPraiseDao.getUpdateBy(ysxPraise);
        }
        return 0;
    }
    ...
    public int getCheck(long praiseId) throws Exception
    {
        ...
        {
            // 执行验证一条数据是否存在
            return ysxPraiseDao.getCheck(praiseId);
        }
        return 0;
    }
    ...
    public int getCheckBy(YsxPraiseBean ysxPraise) throws Exception
    {
        ...
        {
            // 执行验证多条件数据是否存在
            return ysxPraiseDao.getCheckBy(ysxPraise);
        }
        return 0;
    }
    ...
    public void getInsertBatch(List<YsxPraiseBean> list) throws Exception
    {
        ...
        {
            // 执行Batch - 批量新增数据
            ysxPraiseDao.getInsertBatch(list);
        }
    }
