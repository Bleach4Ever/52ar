...
import com.ysx.w2ar.base.dao.tables.YsxMsgQuintessenceDao;
 ...
 */
@Service
public class YsxMsgQuintessenceManager implements IYsxMsgQuintessenceManager {

    private final Logger LOG = Logger.getLogger(getClass());

    @Autowired
    private YsxMsgQuintessenceDao ysxMsgQuintessenceDao;
    ...
    public void getInsert(YsxMsgQuintessenceBean ysxMsgQuintessence) throws Exception
    {
        ...
        // 非空判断
        if( null != ysxMsgQuintessence )
        {
            // 执行新增一条数据
            ysxMsgQuintessenceDao.getInsert(ysxMsgQuintessence);
        }
    }
    ...
    public int getDelete(long qId) throws Exception
    {
        ...
        {
            // 执行删除一条数据
            return ysxMsgQuintessenceDao.getDelete(qId);
        }
        return 0;
    }
    ...
    public int getUpdate(YsxMsgQuintessenceBean ysxMsgQuintessence) throws Exception
    {
        ...
        {
            // 执行变更一条数据
            return ysxMsgQuintessenceDao.getUpdate(ysxMsgQuintessence);
        }
        return 0;
    }
    ...
    public YsxMsgQuintessenceBean getBean(long qId) throws Exception
    {
        ...
        {
            // 执行获取一个Bean实体
            return ysxMsgQuintessenceDao.getBean(qId);
        }
        return null;
    }
    ...
    public List<YsxMsgQuintessenceBean> getList(YsxMsgQuintessenceBean ysxMsgQuintessence) throws Exception
    {
        ...
        {
            // 执行条件查询
            return ysxMsgQuintessenceDao.getList(ysxMsgQuintessence);
        }
        return null;
    }
    ...
    public int getDeleteBean(YsxMsgQuintessenceBean ysxMsgQuintessence) throws Exception
    {
        ...
        {
            // 执行删除一条数据
            return ysxMsgQuintessenceDao.getDeleteBean(ysxMsgQuintessence);
        }
        return 0;
    }
    ...
    public int getDeleteIn(long[] IDs) throws Exception
    {
        ...
        {
            // 执行删除多条数据
            return ysxMsgQuintessenceDao.getDeleteIn(IDs);
        }
        return 0;
    }
    ...
    public int getDeleteBy(YsxMsgQuintessenceBean ysxMsgQuintessence) throws Exception
    {
        ...
        {
            // 执行删除批量数据
            return ysxMsgQuintessenceDao.getDeleteBy(ysxMsgQuintessence);
        }
        return 0;
    }
    ...
    public int getUpdateBy(YsxMsgQuintessenceBean ysxMsgQuintessence) throws Exception
    {
        ...
        {
            // 执行变更批量数据
            return ysxMsgQuintessenceDao.getUpdateBy(ysxMsgQuintessence);
        }
        return 0;
    }
    ...
    public int getCheck(long qId) throws Exception
    {
        ...
        {
            // 执行验证一条数据是否存在
            return ysxMsgQuintessenceDao.getCheck(qId);
        }
        return 0;
    }
    ...
    public int getCheckBy(YsxMsgQuintessenceBean ysxMsgQuintessence) throws Exception
    {
        ...
        {
            // 执行验证多条件数据是否存在
            return ysxMsgQuintessenceDao.getCheckBy(ysxMsgQuintessence);
        }
        return 0;
    }
    ...
    public void getInsertBatch(List<YsxMsgQuintessenceBean> list) throws Exception
    {
        ...
        {
            // 执行Batch - 批量新增数据
            ysxMsgQuintessenceDao.getInsertBatch(list);
        }
    }
